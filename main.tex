...
uses \texttt{scipy.optimize.}\allowbreak\texttt{least\_squares}. Code and derived clean
artifacts are available in an anonymized repository at
\url{https://anonymous.4open.science/r/paper_anon_review-1371/};
...
and writing all the code in the repo. Writing this paper was assisted by
