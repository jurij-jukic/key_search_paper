...
I would like to thank Thomas Hamelryck for the conversations on logical
depth and precision which led to this paper, and his support along the way.
I would also like to thank Luc Baracat and Marija Beljan for helpful discussions.
...
uses \texttt{scipy.optimize.}\allowbreak\texttt{least\_squares}. Public code and derived
clean artifacts are available at
\url{https://github.com/jurij-jukic/key_search_paper_code}; public paper source
is available at \url{https://github.com/jurij-jukic/key_search_paper}.
